...
print('reading data')
mtx_tpm = readMM('data//tasic//simulations//sim_tpm_transposed.mtx')

print('make sce object')
sce = SingleCellExperiment(list(tpm=mtx_tpm))
cellnames = read.csv('data//tasic//simulations//sim_tpm_cells.csv')$cells
genenames = read.csv('data//tasic//simulations//sim_tpm_genes.csv')$gene_name
...
writeMM(qumi,'data//tasic//simulations//sim_qumi_transposed.mtx')
...
writeMM(results,'data//tasic//simulations//sim_census_transposed.mtx')
